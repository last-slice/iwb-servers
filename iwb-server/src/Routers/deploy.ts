import { handlBulkWorldsDeployments, handleWorldDeployment, handleSceneDeploymentReady, handleDeploymentFinished, handleAdminDeployRequest, handleSpecificWorldsDeployments } from "../Objects/Service";
...
export function deployRouter(router:any){
    ...
    router.post("/deployment/worlds/specific/:auth", async (req: any, res: any) => {
        console.log('received specific bulk deployment request', req.body)
        handleSpecificWorldsDeployments(req, res)
    });
