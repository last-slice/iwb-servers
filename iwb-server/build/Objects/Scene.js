...
class Scene extends schema_1.Schema {
    ...
    constructor(room, data) {
        ...
        this[_10] = new schema_1.ArraySchema();
        this.entities = [];
        if (room) {
